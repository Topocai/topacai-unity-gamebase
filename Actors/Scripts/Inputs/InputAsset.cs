...
//     version 1.14.0
//     from Assets/Game/Actors/Scripts/Inputs/InputAsset.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Game/Actors/Scripts/Inputs/InputAsset.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": [
        ...
        ~@InputsSystem()
        {
            UnityEngine.Debug.Assert(!m_GenericMap.enabled, "This will cause a leak and performance issues, InputsSystem.GenericMap.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Haibanme.enabled, "This will cause a leak and performance issues, InputsSystem.Haibanme.Disable() has not been called.");
        }
        ...
        public struct GenericMapActions
        {
            ...
            /// </summary>
            public GenericMapActions(@InputsSystem wrapper) { m_Wrapper = wrapper; }
            /// <summary>
        ...
        public struct HaibanmeActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public HaibanmeActions(@InputsSystem wrapper) { m_Wrapper = wrapper; }
            /// <summary>
